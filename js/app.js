...
(function () {
  ...
  // Scoring: positive = 2, neutral = 1, negative = 0 · pass threshold = 70%
  // ============================================================
  const COMPATIBILITY_THRESHOLD = 70;
  const MAX_COMPATIBILITY_SCORE = 10 * 2;
  ...
  const QUESTIONS = [
    ...
    {
      text: 'Do you think emotional connection matters more than expectations?',
      tone: 'warm',
      answers: [
        { text: 'Absolutely', score: 2 },
        { text: 'Sometimes', score: 1 },
        { text: 'Not always', score: 0 },
      ],
    },
    {
  ...
  function getCompatibilityResult() {
    ...
    const percent = Math.round((totalScore / MAX_COMPATIBILITY_SCORE) * 100);
    return {
      totalScore,
      percent,
